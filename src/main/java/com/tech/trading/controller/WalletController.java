...
import com.tech.trading.model.WalletTransaction;
import com.tech.trading.service.UserService;
import com.tech.trading.service.WalletService;
...
public class WalletController {
    ...
    public ResponseEntity<Wallet> getUserWallet(@RequestHeader("Authorization") String jwt) throws Exception {
        ...
        Wallet wallet=walletService.getUser(user);
    ...
    , @RequestBody WalletTransaction req) throws Exception {
        ...
        Wallet recieverWallet=walletService.findById(walletId);
